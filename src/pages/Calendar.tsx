...
export default function Calendar() {
 ...
 const pagination = usePagination(tasks, JSON.stringify([view,selected,pendingOnly]))
 ...
 function reschedule(event:FormEvent<HTMLFormElement>){event.preventDefault();if(editing){const date=String(new FormData(event.currentTarget).get('due_date'));if(editing.repeat_days&&!date){setError('Tarefas recorrentes precisam de um prazo. Altere a repetição em Tarefas para remover a data.');return}update(editing,{due_date:date||null})}}

...
export interface Task { repeat_days?: number; recurrence_spawned?: boolean; id: string; user_id: string; course_id: string | null; title: string; due_date: string | null; priority: 'low' | 'medium' | 'high'; status: 'pending' | 'doing' | 'done'; created_at: string }
